Rails.application.routes.draw do
  ...
  post("/update_director/:the_id", { :controller => "directors", :action => "update_director" })
  ...
  post("/update_movie/:the_id", { :controller => "movies", :action => "update_movie" })
  ...
  post("/update_actor/:the_id", { :controller => "actors", :action => "update_actor" })
end
